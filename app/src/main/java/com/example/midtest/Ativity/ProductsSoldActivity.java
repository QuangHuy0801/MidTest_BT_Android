...
public class ProductsSoldActivity extends AppCompatActivity {
    ...
    private void setupChart() {
        ...
        API.api.QuantityStatistic(datefrom, dateto).enqueue(new Callback<List<ReportTotal>>() {
            @Override
            public void onResponse(Call<List<ReportTotal>> call, Response<List<ReportTotal>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (reportTotals.isEmpty()) {
                        Toast.makeText(ProductsSoldActivity.this, "Không có dữ liệu", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        tvtotal.setText("Tổng: "+totalRevenue+" sản phẩm");
                    ...
                    Toast.makeText(ProductsSoldActivity.this, "Không thể lấy dữ liệu", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<List<ReportTotal>> call, Throwable t) {
                Toast.makeText(ProductsSoldActivity.this, "Lỗi: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void createExcel(View view)
    {
        ...
        try {
            File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "ThongKeSanPhamDaBan.xls");;
            ...
            Toast.makeText(this, "Tạo thành công: DOWNLOADS/ThongKeSanPhamDaBan.xls", Toast.LENGTH_LONG).show();
